          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <span className="text-xl font-semibold">
                Devloft <span className="text-blue-400">Technologies</span>
              </span>
            </div>
            <p className="text-blue-200 mb-6">
              Building scalable digital and ERP solutions for modern enterprises. Transforming businesses through innovative technology.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-blue-200">hello@devlofttech.com</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-blue-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-blue-200">+91 8147814232</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-blue-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-blue-200">No.804, 772/A, B' Block, 3rd Stage
                  Vijayanagar, 570017 - Mysore, India</span>
              </li>
            </ul>
          </div>
        </div>
